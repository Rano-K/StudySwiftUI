...
struct DashboardView: View {
    ...
    @Query var paymentActivities: [PaymentActivityModel]
    ...
    private var paymentDataForView: [PaymentActivityModel] {
    ...
    @State private var selectedPaymentActivity: PaymentActivityModel?
    ...
    private func delete(payment: PaymentActivityModel) {
    ...
    var body: some View {
        ZStack(alignment: .trailing) {
            ...
            .sheet(isPresented: self.$showPaymentForm, onDismiss: {
                ...
                //모달 시트에 표시될 실제 컨텐츠를 제공하는 클로저 호출
                self.modalContent()
            }
        }
...
struct TransactionCellView: View {
    ...
    var transaction: PaymentActivityModel
...
//    do {
//        let container = try ModelContainer(for: PaymsentActivity.self,
